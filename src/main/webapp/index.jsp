<%-- 
    Document   : index
    Created on : 24/10/2019, 23:34:25
    Author     : olive
--%>
...
<body class="text-center bg-dark">
  ...
  <div class="p-3 h-100 d-flex flex-column" style="">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 mx-auto">
          <h1 class="cover-heading" style=""><b>UBS Review</b></h1>
          <p class="lead">Seja bem vindo ao UBS Review, uma aplicação com o objetivo de repassar a você dados fornecidos pelo governo relacionados às Unidades Básicas de Saúde do Brasil de maneira prática e rápida</p>
          <a href="#" class="btn btn-lg btn-light"><b class="">Sobre</b></a>
        </div>
      </div>
    </div>
    <div class="container mt-auto">
      <div class="row">
        <div class="col-md-12">
          <p class="mt-auto text-secondary">Todos os direitos reservados.</p>
        </div>
      </div>
    </div>
  </div>
